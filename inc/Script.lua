...
if (MsgText[1] == "منشن" or MsgText[1] == "تاك" or MsgText[1] == "منشن " or MsgText[1] == "تاك كوين") then
if not msg.Admin then return " ❍  ** هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'.𖣂 𝙪𝙨𝙚𝙧𝙣𝙖𝙢𝙚 , '..UserNameID..' .\n.𖣂 𝙢𝙨𝙂𝙨 , '..msgs..' .\n.𖣂 𝙨𝙩𝙖𝙨𝙩 , '..msg.TheRank..' .\n.𖣂 𝙡𝘿 , '..msg.sender_user_id_..' .',dl_cb,nil)
		else
	...
	if redis:get("KLISH:ID") then
		...
		sendMsg(msg.chat_id_,msg.id_,'.𖣂 𝙪𝙨𝙚𝙧𝙣𝙖𝙢𝙚 , '..UserNameID..' .\n.𖣂 𝙢𝙨𝙂𝙨 , '..msgs..' .\n.𖣂 𝙨𝙩𝙖𝙨𝙩 , '..msg.TheRank..' .\n.𖣂 𝙡𝘿 , '..msg.sender_user_id_..' .')
		end
end
...
local inline = {{{text="أضِغط هُنا ",url="t.me/BOTKAY"}}}
send_key(msg.sender_user_id_,'  [𝑺 𝑲 𝑬 𝑳 𝑬 𝑻 𝑶 𝑵](t.me/BOTKAY)',nil,inline,msg.id_)
return false
end
...
if not msg.Admin then return "هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local text = [[
❍م1❙ الرفع والتنزيل
❍م2❙ اوامر الاعدادات
❍م3❙ اوامر الحماية
❍م4❙ اوامر الخدمة
❍م5❙ اوامر التعطيل والتفعيل+ اوامر الفلة
❍ الوسائط❙ عرض اعدادات الوسائط
❍ الاعدادات❙ عرض اعدادات المجموعه

❍للاستفسار تواصل مع المطور: ]]..SUDO_USER
...
❒ اوامر الحظر~الطرد~التقييد

❍ حظر بالرد ← بالمعرف لحظر العضو
❍ الغاء الحظر بالرد ← بالمعرف لإلغاء حظر العضو
❍ طرد بالرد ← بالمعرف لطرد العضو


❍ كتم بالرد ← بالمعرف لا يستطيع ارسال شيء
❍ الغاء الكتم بالرد ← بالمعرف لإلغاء الكتم
❍ تقييد بالرد ← بالمعرف لوضع لتقييد العضو


❍ فك التقييد بالرد ← بالمعرف لفك التقييد
...
◎م2
اوامر الاعدادات
❍ الرابط ← لعرض رابط المجموعة
❍ انشاء رابط ← لإنشاء رابط جديد
...
❍ قائمه الاوامر ← لمعرفه الاوامر المضافه
...
❍ الرتبه بالرد ← لعرض رتبة الشخص
❍ التفاعل بالمعرف-بالرد ←لعرض تفاعل الشخص
❍ كشف بالرد-المعرف ← لأظهار معلومات الشخص

❍ كشف البوتات ← لكشف جميع البوتات
❍ طرد البوتات ← طرد جميع البوتات فالمجموعة
❍ طرد المحذوفين ← طرد الحسابات المحذوفه
...
❍ رفع منشئ اساسي ← رفع منشئ اساسي فالبوت

❍ اذاعه← للنشر لكل المجموعات
❍ اذاعه خاص ← للنشر لكل المشتركين
❍ اذاعه عام ← للنشر الى المجموعات والمشتركين

❍ اذاعه بالتوجيه← للنشر لكل المجموعات بالتوجيه للكل
❍ اذاعه خاص بالتوجيه ← للنشر لكل المشتركين بالتوجيه للكل
❍ اذاعه عام بالتوجيه ← للنشر الى المجموعات والمشتركين بالتوجيه للكل
...
return [[
[𝑺 𝑲 𝑬 𝑳 𝑬 𝑻 𝑶 𝑵](https://t.me/BOTKAY)

[مطور السورس](https://t.me/SPPPN)
]]
end
...
local CountRdod2 = 100 - tonumber(CountRdod)
local CountRdod = 99 - tonumber(CountRdod)
...
elseif not msg.SudoUser and Text==" بغ٦ت" or Text == "بغنتي" then
sendMsg(msg.chat_id_,msg.id_,sss[math.random(#sss)])
elseif not msg.SudoUser and Text=="امحح" or Text == "بوسه" then
return 
sendMsg(msg.chat_id_,msg.id_,bs[math.random(#bs)])

elseif not msg.SudoUser and Text==" عبفغعه" or Text == "بفغاابيقه" then
...
elseif Text== "رفع تاج راس التيلي"  then return sendMsg(msg.chat_id_,msg.id_," ❍ أهلاً عزيزي\n ❍  تم رفعه بنجاح\n ❍  الان اصبح تاج راس التيلي كله\n")
elseif Text== "تنزيل تاج راس التيلي"  then return sendMsg(msg.chat_id_,msg.id_," ❍ أهلاً عزيزي\n ❍  تم تنزيل السبك بنجاح\n ❍  للأسف م يستاهل تاج راس التلي\n")
...
elseif Text== "رفع فخر العرب"  then return sendMsg(msg.chat_id_,msg.id_," ❍ أهلاً عزيزي\n ❍  تم رفع العضو فخر العرب بنجاح\n ❍  اصبح خط احمر\n")
elseif Text== "تنزيل فخر العرب"  then return sendMsg(msg.chat_id_,msg.id_," ❍ أهلاً عزيزي\n ❍  تم تنزيل العضو\n ❍  من قائمة فخر العرب بنجاح\n")
...
elseif Text== "رفع هطف"  then return sendMsg(msg.chat_id_,msg.id_," ❍ أهلاً عزيزي\n ❍  الان اصبح هطف\n")
elseif Text== "تنزيل هطف"  then return sendMsg(msg.chat_id_,msg.id_," ❍ أهلاً عزيزي\n ❍  تم تنزيله هطف من القروب بنجاح\n ❍  الان اصبح ليس هطف\n")
...
‏
  ...
  --=====================================
  elseif Text== "مطور السورس" or Text== "مطور كاي" or Text=="مطور سورس كاي" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[𝖔𝖒𝖆𝖗 🇸🇦|🇰🇼](https://t.me/SPPPN)")
end 
end 
